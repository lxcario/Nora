...
const COUNTRIES: { query: string; limit: number }[] = [
  { query: "turkiye", limit: Infinity },
  { query: "azerbaijan", limit: Infinity },
  { query: "united+states", limit: Infinity },
  { query: "united+kingdom", limit: Infinity },
  { query: "germany", limit: Infinity },
  { query: "canada", limit: Infinity },
  { query: "netherlands", limit: Infinity },
  { query: "australia", limit: Infinity },
  { query: "france", limit: Infinity },
  { query: "italy", limit: Infinity },
  { query: "spain", limit: Infinity },
  { query: "japan", limit: Infinity },
  { query: "south+korea", limit: Infinity },
  { query: "china", limit: Infinity },
  { query: "india", limit: Infinity },
  { query: "brazil", limit: Infinity },
  { query: "mexico", limit: Infinity },
  { query: "russia", limit: Infinity },
  { query: "sweden", limit: Infinity },
  { query: "norway", limit: Infinity },
  { query: "denmark", limit: Infinity },
  { query: "finland", limit: Infinity },
  { query: "switzerland", limit: Infinity },
  { query: "austria", limit: Infinity },
  { query: "poland", limit: Infinity },
  { query: "czech+republic", limit: Infinity },
  { query: "ireland", limit: Infinity },
  { query: "portugal", limit: Infinity },
  { query: "belgium", limit: Infinity },
  { query: "singapore", limit: Infinity },
  { query: "malaysia", limit: Infinity },
  { query: "indonesia", limit: Infinity },
  { query: "pakistan", limit: Infinity },
  { query: "egypt", limit: Infinity },
  { query: "south+africa", limit: Infinity },
  { query: "nigeria", limit: Infinity },
  { query: "israel", limit: Infinity },
  { query: "united+arab+emirates", limit: Infinity },
  { query: "saudi+arabia", limit: Infinity },
  { query: "new+zealand", limit: Infinity },
  { query: "argentina", limit: Infinity },
  { query: "colombia", limit: Infinity },
  { query: "chile", limit: Infinity },
  { query: "philippines", limit: Infinity },
  { query: "thailand", limit: Infinity },
  { query: "vietnam", limit: Infinity },
  { query: "greece", limit: Infinity },
  { query: "romania", limit: Infinity },
  { query: "hungary", limit: Infinity },
  { query: "ukraine", limit: Infinity },
  { query: "georgia", limit: Infinity },
  { query: "kazakhstan", limit: Infinity },
];
